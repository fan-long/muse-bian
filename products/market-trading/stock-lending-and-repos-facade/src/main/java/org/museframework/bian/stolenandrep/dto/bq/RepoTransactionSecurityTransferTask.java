...
@MetaDto
public class RepoTransactionSecurityTransferTask {
    ...
    public void setRepoTransactionSecurityTransferTaskType(String repoTransactionSecurityTransferTaskType) {
        this.repoTransactionSecurityTransferTaskType = repoTransactionSecurityTransferTaskType;
    }

    public String getRepoTransactionSecurityTransferTaskType() {
        return repoTransactionSecurityTransferTaskType;
    }
}