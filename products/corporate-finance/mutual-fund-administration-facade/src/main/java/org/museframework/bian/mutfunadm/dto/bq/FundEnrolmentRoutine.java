...
@MetaDto
public class FundEnrolmentRoutine {
    ...
    /*The Fund Enrolment Routine specific Business Service*/
    @MetaField(ref=true)
    ...
    /*Reference to Fund Enrolment Routine*/
    @MetaField(ref=true)
    private org.museframework.bian.classes.Plan mutualFundAdministrativePlanReference;

    /*Reference to Fund Enrolment Routine*/
    @MetaField(ref=true)
    private org.museframework.bian.classes.PlannedAction fundEnrolmentRoutineReference;

    /*The type of Fund Enrolment Routine*/
    @MetaField
    private String fundEnrolmentRoutineType;
    ...
    public void setFundEnrolmentRoutineReference(org.museframework.bian.classes.PlannedAction fundEnrolmentRoutineReference) {
        this.fundEnrolmentRoutineReference = fundEnrolmentRoutineReference;
    }

    public org.museframework.bian.classes.PlannedAction getFundEnrolmentRoutineReference() {
        return fundEnrolmentRoutineReference;
    }

    public void setFundEnrolmentRoutineType(String fundEnrolmentRoutineType) {
        this.fundEnrolmentRoutineType = fundEnrolmentRoutineType;
    }

    public String getFundEnrolmentRoutineType() {
        return fundEnrolmentRoutineType;
    }
}