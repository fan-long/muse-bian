...
public class FundManagementRoutine {
    ...
    /*The Fund Management Routine specific Business Service*/
    ...
    /*Reference to Fund Management Routine*/
    private org.museframework.bian.classes.Plan hedgeFundAdministrativePlanReference;

    /*Reference to Fund Management Routine*/
    private org.museframework.bian.classes.PlannedAction fundManagementRoutineReference;

    /*The type of Fund Management Routine*/
    private String fundManagementRoutineType;
    ...
    public void setFundManagementRoutineReference(org.museframework.bian.classes.PlannedAction fundManagementRoutineReference) {
        this.fundManagementRoutineReference = fundManagementRoutineReference;
    }

    public org.museframework.bian.classes.PlannedAction getFundManagementRoutineReference() {
        return fundManagementRoutineReference;
    }

    public void setFundManagementRoutineType(String fundManagementRoutineType) {
        this.fundManagementRoutineType = fundManagementRoutineType;
    }

    public String getFundManagementRoutineType() {
        return fundManagementRoutineType;
    }
}