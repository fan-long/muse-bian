...
@MetaDto
public class BankGuaranteedPaymentSpecificationTask {
    ...
    /*The type of Bank Guaranteed Payment Specification Task*/
    @MetaField
    private String bankGuaranteedPaymentSpecificationTaskType;
    ...
    public void setBankGuaranteedPaymentSpecificationTaskType(String bankGuaranteedPaymentSpecificationTaskType) {
        this.bankGuaranteedPaymentSpecificationTaskType = bankGuaranteedPaymentSpecificationTaskType;
    }

    public String getBankGuaranteedPaymentSpecificationTaskType() {
        return bankGuaranteedPaymentSpecificationTaskType;
    }
}