...
public class LetterofCreditIssuanceandBookingTask {
    ...
    public void setLetterofCreditIssuanceandBookingTaskType(String letterofCreditIssuanceandBookingTaskType) {
        this.letterofCreditIssuanceandBookingTaskType = letterofCreditIssuanceandBookingTaskType;
    }

    public String getLetterofCreditIssuanceandBookingTaskType() {
        return letterofCreditIssuanceandBookingTaskType;
    }
}