...
public class ProductionIssueDeterminationWorkstep {
    ...
    public void setProductionIssueDeterminationWorkstepReference(org.museframework.bian.classes.Workstep productionIssueDeterminationWorkstepReference) {
        this.productionIssueDeterminationWorkstepReference = productionIssueDeterminationWorkstepReference;
    }

    public org.museframework.bian.classes.Workstep getProductionIssueDeterminationWorkstepReference() {
        return productionIssueDeterminationWorkstepReference;
    }

    public void setProductionIssueDeterminationWorkstepType(String productionIssueDeterminationWorkstepType) {
        this.productionIssueDeterminationWorkstepType = productionIssueDeterminationWorkstepType;
    }

    public String getProductionIssueDeterminationWorkstepType() {
        return productionIssueDeterminationWorkstepType;
    }
}